...
* Temperature, t (or θ), C, celsius, thermometer, thermocouple, $\textcelsius$ celsius/centigrade, $\textdegree{}F$ fahrenheit, ${\celsius}$ = (${\degree F}$ - 32) x 5/9, F = C + 32 x 1.8, when time t is used UK OCR use θ (theta) for temperature in Celsius
